...
def index():
    ...
    classes = [{'classInfo': {'code': 'CSC324', 'title': 'DevOps'}, 'instructor': 'Baoqiang Yan'},
               {'classInfo': {'code': 'CSC184', 'title': 'Python Programming'}, 'instructor': 'Evan Noynaer'}]
...
def loginAPI():
    ...
    if username == 'ike' and password == '123':
...
@app.route('/me')
def userHomePage():
    return render_template('ike.html', title='ike')